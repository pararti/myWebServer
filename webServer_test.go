...
func insert_record(query string) {
	connStr := "user=postgres dbname=s2 sslomode=disable"
	db, err := sql.Open("postgres", connStr)
	if err != nil{
		fmt.Println(err)
		return
...
func Test_count(t *testing.T){
	...
	insert_record("INSERT INTO users (first_name, last_name) VALUES ('Leonid', 'Zykin')")
	insert_record("INSERT INTO users (first_name, last_name) VALUES ('Danil', 'Valliulin')")
	insert_record("INSERT INTO users (first_name, last_name) VALUES ('Artyom', 'Parshin')")
...
func Test_record(t *testing.T){
	create_table()
	insert_record("INSERT INTO users (first_name, last_name) VALUES ('Bob', 'Marli')")
	...
	if rr.Body.String() != "<h3 align=\"center\">1, Bob, Marli</h3>\n"{
